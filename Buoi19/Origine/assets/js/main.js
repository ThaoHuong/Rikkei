...
--------------------------------------------*/
  ...
  heroSlider.not(".slick-initialized").slick({
    ...
    slidesToShow: 1,
    prevArrow:
      '<button type="button" class="slick-prev"> <i class="icon-chevron-left"> </i></button>',
    nextArrow:
      '<button type="button" class="slick-next"><i class="icon-chevron-right"> </i></button>',
    responsive: [
      {
        breakpoint: 767,
        settings: {
...
--------------------------------------------*/
  ...
  heroSlider_three.not(".slick-initialized").slick({
    arrows: true,
    autoplay: false,
    autoplaySpeed: 5000,
    dots: false,
...
--------------------------------------------*/
  ...
  heroSlider_four.not(".slick-initialized").slick({
    arrows: false,
    autoplay: false,
    autoplaySpeed: 5000,
    dots: true,
  ...
  product_two_row_4.not(".slick-initialized").slick({
    dots: false,
    infinite: true,
    rows: 2,
    slidesToShow: 6,
  ...
  product_two_row_5.not(".slick-initialized").slick({
    dots: false,
    infinite: true,
    rows: 2,
    slidesToShow: 5,
  ...
  product_two_row_3.not(".slick-initialized").slick({
    dots: false,
    infinite: true,
    rows: 2,
    slidesToShow: 3,
...
--------------------------------------------*/
  ...
  product_3.not(".slick-initialized").slick({
    dots: false,
    infinite: true,
    slidesToShow: 3,
    slidesToScroll: 1,
  ...
  product_6.not(".slick-initialized").slick({
    dots: false,
    infinite: true,
    slidesToShow: 6,
    slidesToScroll: 1,
  ...
  product_One.not(".slick-initialized").slick({
    dots: false,
    infinite: true,
    slidesToShow: 1,
    slidesToScroll: 1,
  ...
  latestBlog.not(".slick-initialized").slick({
    dots: false,
    infinite: true,
    slidesToShow: 3,
    slidesToScroll: 1,
...
-----------------------------*/
  ...
  brandActiveTwo.not(".slick-initialized").slick({
    dots: false,
    infinite: true,
    slidesToShow: 6,
    slidesToScroll: 1,
  ...
  ourBrand.on("init afterChange", function (e) {
    ...
    $(this)
      ...
      .removeClass("first-elem last-elem");
    $(this)
      .find(".slick-slide.slick-active.slick-current")
      .removeClass("first-elem last-elem");
  });

  ourBrand.not(".slick-initialized").slick({
    arrows: false,
    autoplay: true,
    autoplaySpeed: 7000,
    dots: false,
...
------------------------------*/
  ...
  $(".product-nav")
    ...
    .slick({
      ...
      focusOnSelect: true,
      prevArrow:
        '<button type="button" class="slick-prev"><i class="icon-chevron-thin-left"></i></button>',
      nextArrow:
        '<button type="button" class="slick-next"><i class="icon-chevron-thin-right"></i></button>',
      responsive: [
        {
          breakpoint: 576,
          settings: {
